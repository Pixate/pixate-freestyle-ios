...
#
. $PX_FREESTYLE_SCRIPT/build_framework.sh
...
#
. $PX_FREESTYLE_SCRIPT/build_samples.sh Release
. $PX_FREESTYLE_SCRIPT/build_samples.sh Debug

# -----------------------------------------------------------------------------
# Call out to build distribution (suppress building framework)
#
. $PX_FREESTYLE_SCRIPT/build_distribution.sh
